...
<main class="main account">
        ...
        <form action="{{route('Store-User-Details')}}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <option value="">Select State</option> </br></br>   
               </select>                    
                </div>              
                <div class="col-md-3">
  ...
  <option value="zimbabwean">Zimbabwean</option>
            ...
            <br>
            <hr>
            <p class="text-left"> <strong>Banking Details:</strong> </p>
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-5">
                    <p class="text-grey">Please provide complete bank account detail, otherwise the commission can not be presented.</p>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-checkbox mb-0">
                        ...
                        <label class="form-control-label ls-s" for="terms&condition">I have read and agreed <a href="#">Registration agreement</a></label>
                    </div>
                </div>
                <div class="col-md-3">
