...
<main class="main account">
    ...
    <div class="page-header pl-4 pr-4" style="background-image: url({{asset('images/refferal.jpg')}}">
        ...
        <h1 class="page-title font-weight-bold lh-1 text-capitalize text-dark">Referral</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="site-ref-link">
                    <p>Share Your Link and Earn More</p>
                    ...
                    <br>
                     ...
                     {!! QrCode::size(100)->generate(url('/register?referal_code=' . $ref)); !!}                        <button type="button" class="btn btn-primary btn-md" style="transform: translate(60px, -44px);">Download</button>
                    </a>
                    <form action="{{route('Share-Referal')}}" method="POST">
                        @csrf
                        <br>
                        <div class="col-md-10">
                            <input type="email" name="email" class="form-control" placeholder="Enter Receipent">
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm btn-block"><i class="fa fa-share"></i> Share the link</button>
                            </div>
                    </form>
                </div>
            </div>
